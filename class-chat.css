...
/* =========================================================
   v14 GC ADMIN TOOLS VISUAL POLISH
   Cleaner cards, readable inputs, stronger buttons, better dark mode.
========================================================= */
.classChatGcAdminPanel {
  display: grid;
  gap: 16px;
...
.classChatGcAdminTitle {
  ...
  background:
    radial-gradient(circle at top right, rgba(247,198,0,.35), transparent 34%),
    linear-gradient(180deg, #fff9db 0%, #fff2bb 100%);
  padding: 14px 16px;
...
.classChatGcDanger {
  ...
  background:
    linear-gradient(180deg, rgba(255,255,255,.97), rgba(250,247,239,.98));
  padding: 16px;
  box-shadow:
...
.classChatGcAdminCard::before,
.classChatGcDanger::before {
  content: "";
  position: absolute;
  inset: 0 auto 0 0;
  width: 5px;
  background: linear-gradient(180deg, #f7c600, #ffae00);
  opacity: .95;
}

.classChatGcDanger::before {
  background: linear-gradient(180deg, #ff6b6b, #d11f3a);
}
...
.classChatGcAdminCard label,
.classChatGcDanger label {
  display: block;
  margin: 0 0 6px;
  font-size: .83rem;
  font-weight: 900;
...
.classChatGcAdminPanel .classChatUtilityHint {
  margin: 0 0 10px;
  color: rgba(17,17,17,.68);
  font-size: .8rem;
  line-height: 1.45;
...
.classChatGcAdminPanel textarea:focus {
  outline: none;
  border-color: #f7c600;
  box-shadow: 0 0 0 4px rgba(247,198,0,.18);
  transform: translateY(-1px);
}

.classChatGcAdminPanel button,
.classChatGcMemberRow button {
  appearance: none;
  border: 0;
  border-radius: 999px;
...
.classChatGcAdminPanel button:hover,
.classChatGcMemberRow button:hover {
  transform: translateY(-1px);
  filter: brightness(1.05);
  box-shadow: 0 10px 20px rgba(17,17,17,.22);
}

.classChatGcAdminPanel button:active,
.classChatGcMemberRow button:active {
  transform: translateY(0);
}

.classChatGcAdminPanel button:disabled,
.classChatGcMemberRow button:disabled {
  opacity: .6;
  cursor: wait;
  transform: none;
}
...
.classChatGcMemberList::-webkit-scrollbar {
  width: 10px;
}

.classChatGcMemberList::-webkit-scrollbar-thumb {
  border-radius: 999px;
...
.classChatGcDanger {
  display: grid;
  gap: 12px;
  border-color: rgba(209,31,58,.20);
  background:
    radial-gradient(circle at top right, rgba(255,107,107,.18), transparent 34%),
    linear-gradient(180deg, #fff6f6 0%, #ffe9ea 100%);
}
...
.classChatGcDanger button {
  justify-self: start;
  background: linear-gradient(180deg, #d11f3a 0%, #ac1630 100%) !important;
  color: #fff !important;
}

.classChatGcDanger button:hover {
  filter: brightness(1.04);
}

.classChatPanel.is-dark .classChatGcAdminTitle {
  border-color: rgba(255,255,255,.10);
  background:
    radial-gradient(circle at top right, rgba(247,198,0,.20), transparent 36%),
    linear-gradient(180deg, #2b2410 0%, #1c1b15 100%);
  box-shadow: 0 16px 34px rgba(0,0,0,.34);
}

.classChatPanel.is-dark .classChatGcAdminTitle h4 {
  color: #fff;
}

.classChatPanel.is-dark .classChatGcAdminTitle p {
  color: rgba(255,255,255,.72);
}

.classChatPanel.is-dark .classChatGcAdminCard,
.classChatPanel.is-dark .classChatGcDanger {
  border-color: rgba(255,255,255,.10);
  background:
    linear-gradient(180deg, rgba(37,37,37,.98), rgba(23,23,23,.98));
  box-shadow:
    0 18px 36px rgba(0,0,0,.34),
    inset 0 1px 0 rgba(255,255,255,.04);
}

.classChatPanel.is-dark .classChatGcAdminCard h4,
.classChatPanel.is-dark .classChatGcDanger h4,
.classChatPanel.is-dark .classChatGcAdminCard label {
  color: #fff;
}

.classChatPanel.is-dark .classChatGcAdminPanel .classChatUtilityHint,
.classChatPanel.is-dark .classChatGcDanger p,
.classChatPanel.is-dark .classChatGcMemberRow small {
  color: rgba(255,255,255,.72);
}

.classChatPanel.is-dark .classChatGcAdminPanel textarea {
  border-color: rgba(255,255,255,.10);
  background: #101010;
  color: #fff;
...
.classChatPanel.is-dark .classChatGcAdminPanel textarea:focus {
  border-color: #f7c600;
  box-shadow: 0 0 0 4px rgba(247,198,0,.16);
}

.classChatPanel.is-dark .classChatGcMemberRow {
  border-color: rgba(255,255,255,.08);
  background: linear-gradient(180deg, #202020, #181818);
  box-shadow: 0 10px 18px rgba(0,0,0,.22);
}

.classChatPanel.is-dark .classChatGcMemberRow strong {
  color: #fff;
}

.classChatPanel.is-dark .classChatGcMemberRow button,
.classChatPanel.is-dark .classChatGcAdminPanel button {
  background: linear-gradient(180deg, #f7c600 0%, #efb100 100%);
  color: #111;
  box-shadow: 0 12px 24px rgba(0,0,0,.28);
}

.classChatPanel.is-dark .classChatGcDanger button {
  background: linear-gradient(180deg, #ff6b6b 0%, #d82a45 100%) !important;
  color: #fff !important;
}

.classChatPanel.is-dark .classChatGcMemberList::-webkit-scrollbar-thumb {
