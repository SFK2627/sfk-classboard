const CACHE_NAME = "sfk-admin-pwa-v103-birthday-mobile-center";
...
const APP_SHELL = [
  ...
  "./sw.js",
  "../admin.html?embedded=1&v=birthday-mobile-center-v103",
  "../admin.css?v=birthday-mobile-center-v103",
  "../admin.js?v=birthday-mobile-center-v103",
  "../class-chat-admin.js",
  "../firebase-config.js",
