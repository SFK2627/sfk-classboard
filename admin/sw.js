const CACHE_NAME = "sfk-admin-pwa-v454-freedom-wall";
...
const APP_SHELL = [
  ...
  "./sw.js",
  "../admin.html?embedded=1&v=v454-freedom-wall",
  "../admin.css?v=v454-freedom-wall",
  "../admin.js?v=v454-freedom-wall",
  "../class-chat-admin.js",
  "../firebase-config.js",
  "../firebase-adapter.js?v=v454-freedom-wall",
  "../auth.js",
  "../orientation-lock.js",
  "../icons/icon-192.png",
  "../icons/icon-512.png",
