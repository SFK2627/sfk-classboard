const CACHE_NAME = "sfk-admin-pwa-v99-loading-sound-fix-shortcut-toggle";
...
const APP_SHELL = [
  ...
  "./sw.js",
  "../admin.html?embedded=1&v=loading-sound-fix-shortcut-toggle-v99",
  "../admin.css?v=loading-sound-fix-shortcut-toggle-v99",
  "../admin.js?v=loading-sound-fix-shortcut-toggle-v99",
  "../class-chat-admin.js",
  "../firebase-config.js",
