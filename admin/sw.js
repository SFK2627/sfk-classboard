const CACHE_NAME = "sfk-admin-pwa-v111-famous-tones";
...
const APP_SHELL = [
  ...
  "./sw.js",
  "../admin.html?embedded=1&v=famous-loading-tones-v111",
  "../admin.css?v=famous-loading-tones-v111",
  "../admin.js?v=famous-loading-tones-v111",
  "../class-chat-admin.js",
  "../firebase-config.js",
