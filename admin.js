...
function applyHomepageDesignPreset(name) {
  const presets = {
    ...
    dark: {
      ...
      HomepagePrayerCardBorder: "#ffd000",
      HomepagePrayerCardText: "#fff8d8",
      HomepagePrayerNameColor: "#fff8d8",
      HomepagePrayerDividerColor: "#ffd000",
      HomepageCleanersBoxBg: "#000000",
      HomepageCleanersBorderColor: "#ffd000",
      HomepageCleanersLabelColor: "#fff8d8",
      HomepageCleanersTextColor: "#ffd000",
      HomepageBirthdayCardBg: "#1d1d24",
      HomepageBirthdayCardBorder: "#ffd000",
      HomepageBirthdayCardAccent: "#ffd000",
      HomepageBirthdayDateBg: "#000000",
      HomepageBirthdayDateTextColor: "#ffd000",
      HomepageBirthdayDateBorder: "#ffd000",
      HomepageBirthdayInnerBg: "#000000",
      HomepageBirthdayInnerBorder: "#ffd000",
      HomepageBirthdayGreetingColor: "#ffd000",
      HomepageBirthdayCelebrantColor: "#ffffff",
      HomepageBirthdayMessageColor: "#fff8d8",
      HomepageBirthdayEmptyBg: "#000000",
      HomepageBirthdayEmptyText: "#ffd000",
